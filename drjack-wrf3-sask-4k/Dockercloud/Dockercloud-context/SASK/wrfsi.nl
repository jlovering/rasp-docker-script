&project_id
 SIMULATION_NAME = 'SIMULATION_NAME = 'BayArea WRF Model Simulation''
 USER_DESC = 'jlovering'
/
&filetimespec
 START_YEAR = 2002,
...
&hgridspec
 ...
 PARENT_ID = 1, 1
 RATIO_TO_PARENT = 1, 3
 DOMAIN_ORIGIN_LLI = 1, 10
 DOMAIN_ORIGIN_LLJ = 1, 10
 DOMAIN_ORIGIN_URI = 51, 41
 DOMAIN_ORIGIN_URJ = 51, 41
 MAP_PROJ_NAME = 'lambert'
 MOAD_KNOWN_LAT = 51.295
 MOAD_KNOWN_LON = -105.783
 MOAD_STAND_LATS = 51.295, 51.295
 MOAD_STAND_LONS = -105.783
 MOAD_DELTA_X = 12000
 MOAD_DELTA_Y = 12000
 SILAVWT_PARM_WRF = 0.
 TOPTWVL_PARM_WRF = 2.
